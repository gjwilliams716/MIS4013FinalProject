            ...
            <div class="modal-body">
                <form method="post" action="">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="player" name="player" value="<?php echo $outbl['player']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="g" class="form-label">Games Played</label>
                        <input type="text" class="form-control" id="g" name="g" value="<?php echo $outbl['g']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="solo" class="form-label">Solo Tackles</label>
                        <input type="text" class="form-control" id="solo" name="solo" value="<?php echo $outbl['solo']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="ast" class="form-label">Assisted Tackles</label>
                        <input type="text" class="form-control" id="ast" name="ast" value="<?php echo $outbl['ast']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="tot" class="form-label">Total Tackles</label>
                        <input type="text" class="form-control" id="tot" name="tot" value="<?php echo $outbl['tot']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="loss" class="form-label">Tackles for Loss</label>
                        <input type="text" class="form-control" id="loss" name="loss" value="<?php echo $outbl['loss']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="sk" class="form-label">Sacks</label>
                        <input type="text" class="form-control" id="sk" name="sk" value="<?php echo $outbl['sk']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="inte" class="form-label">Interceptions</label>
                        <input type="text" class="form-control" id="inte" name="inte" value="<?php echo $outbl['inte']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="fr" class="form-label">Fumble Recoveries</label>
                        <input type="text" class="form-control" id="fr" name="fr" value="<?php echo $outbl['fr']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="ff" class="form-label">Forced Fumbles</label>
                        <input type="text" class="form-control" id="ff" name="ff" value="<?php echo $outbl['ff']; ?>">
                    </div>
