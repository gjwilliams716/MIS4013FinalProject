<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editKeeperModal<?php echo $outbl['player']; ?>">
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" id="pLast<?php echo $outbl['player']; ?>" name="pLast" value="<?php echo $keeper['last_name']; ?>">
  </div>
          <div class="mb-3">
    <label for="pContact<?php echo $keeper['player']; ?>" class="form-label">Contact</label>
